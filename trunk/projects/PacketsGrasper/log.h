...
#define LTRC_ BOOST_LOG_USE_LOG_IF_LEVEL(g_log_app(), g_log_level(), debug )  <<"[PacketGrasper]  [TRACE]{@"<<__FUNCTION__<<"} "
...
#define LTRC_WITHOUT	 BOOST_LOG_USE_LOG_IF_LEVEL(g_log_app(), g_log_level(), debug )  <<"[PacketGrasper]"
