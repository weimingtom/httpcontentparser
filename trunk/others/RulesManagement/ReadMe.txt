========================================================================
    活动模板库 : RulesManagement 项目概况
========================================================================

应用程序向导为您创建了这个 RulesManagement 项目，供您用作
编写动态链接库(DLL)的起点。
...
RulesManagement.idl
    ...
    此文件将由 MIDL 编译器处理以生成:
        C++ 接口定义和 GUID 声明(RulesManagement.h)
        GUID 定义(RulesManagement_i.c)
        类型库(RulesManagement.tlb)
        封送处理代码(RulesManagement_p.c and dlldata.c)

RulesManagement.h
    此文件包含在 RulesManagement.idl 中定义的项的 C++
...
StdAfx.h、StdAfx.cpp
    这些文件用于生成名为 RulesManagement.pch
...
RulesManagementps.vcproj
	...
	dlldata.c、RulesManagement_i.c 和 RulesManagement_p.c，这些是
