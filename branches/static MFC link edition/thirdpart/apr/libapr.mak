...
!IF "$(CFG)" != "libapr - Win32 Release" && "$(CFG)" != "libapr - Win32 Debug" && "$(CFG)" != "libapr - Win32 ReleaseNT" && "$(CFG)" != "libapr - Win32 DebugNT" && "$(CFG)" != "libapr - x64 Release" && "$(CFG)" != "libapr - x64 Debug"
...
CPP=cl.exe
CPP_PROJ=/nologo /MD /W3 /Zi /O2 /Oy- /I "./include" /I "./include/arch" /I "./include/arch/win32" /I "./include/arch/unix" /D "NDEBUG" /D "APR_DECLARE_EXPORT" /D "WINNT" /D "WIN32" /D "_WINDOWS" /Fo"$(INTDIR)\\" /Fd"$(INTDIR)\libapr_src" /FD /c 
...
TargetPath=.\NT\Release\libapr-1.dll
SOURCE="$(InputPath)"
PostBuild_Desc=Embed .manifest
DS_POSTBUILD_DEP=$(INTDIR)\postbld.dep
...
"$(DS_POSTBUILD_DEP)" : "$(OUTDIR)\libapr-1.dll"
   if exist .\NT\Release\libapr-1.dll.manifest mt.exe -manifest .\NT\Release\libapr-1.dll.manifest -outputresource:.\NT\Release\libapr-1.dll;2
	echo Helper for Post-build step > "$(DS_POSTBUILD_DEP)"
...
CPP=cl.exe
CPP_PROJ=/nologo /MDd /W3 /Zi /Od /I "./include" /I "./include/arch" /I "./include/arch/win32" /I "./include/arch/unix" /D "_DEBUG" /D "APR_DECLARE_EXPORT" /D "WINNT" /D "WIN32" /D "_WINDOWS" /Fo"$(INTDIR)\\" /Fd"$(INTDIR)\libapr_src" /FD /EHsc /c 
...
"$(DS_POSTBUILD_DEP)" : "$(OUTDIR)\libapr-1.dll"
   if exist .\NT\Debug\libapr-1.dll.manifest mt.exe -manifest .\NT\Debug\libapr-1.dll.manifest -outputresource:.\NT\Debug\libapr-1.dll;2
	echo Helper for Post-build step > "$(DS_POSTBUILD_DEP)"
