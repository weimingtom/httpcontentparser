...
#define LTRC_(MSG)		BOOST_LOG_USE_LOG_IF_LEVEL(g_log_dbg(), g_log_level(), debug )  \
	<<"[PacketGrasper][TRACE]{@"<<__FUNCTION__<<"} "<<MSG;
#define LDBG_(MSG)		BOOST_LOG_USE_LOG_IF_LEVEL(g_log_dbg(), g_log_level(), debug )	\
	<<"[PacketGrasper][DEBUG]{@"<<__FUNCTION__<<"} "<<MSG;
