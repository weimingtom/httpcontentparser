========================================================================
    活动模板库 : RulesHolder 项目概况
========================================================================

应用程序向导为您创建了这个 RulesHolder 项目，供您用作
编写可执行文件(EXE)的起点。
...
RulesHolder.idl
    ...
    此文件将由 MIDL 编译器处理以生成:
        C++ 接口定义和 GUID 声明(RulesHolder.h)
        GUID 定义(RulesHolder_i.c)
        类型库(RulesHolder.tlb)
        封送处理代码(RulesHolder_p.c and dlldata.c)

RulesHolder.h
    此文件包含在 RulesHolder.idl 中定义的项的 C++
