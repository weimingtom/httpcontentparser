...
HRESULT CVisualStylesXP::DrawThemeText(HTHEME hTheme, HDC hdc, INT_PTR iPartId, 
...
HRESULT CVisualStylesXP::HitTestThemeBackground(HTHEME hTheme,  HDC hdc, INT_PTR iPartId, 
...
HRESULT CVisualStylesXP::DrawThemeEdge(HTHEME hTheme, HDC hdc, INT_PTR iPartId, INT_PTR iStateId, 
...
HRESULT CVisualStylesXP::DrawThemeIcon(HTHEME hTheme, HDC hdc, INT_PTR iPartId, 
...
BOOL CVisualStylesXP::IsThemePartDefined(HTHEME hTheme, INT_PTR iPartId, 
										 INT_PTR iStateId)
{
...
HRESULT CVisualStylesXP::GetThemeColor(HTHEME hTheme, INT_PTR iPartId, 
...
HRESULT CVisualStylesXP::GetThemeMetric(HTHEME hTheme,  HDC hdc, INT_PTR iPartId, 
...
HRESULT CVisualStylesXP::GetThemeString(HTHEME hTheme, INT_PTR iPartId, 
...
HRESULT CVisualStylesXP::GetThemeBool(HTHEME hTheme, INT_PTR iPartId, 
...
HRESULT CVisualStylesXP::GetThemeInt(HTHEME hTheme, INT_PTR iPartId, 
									 INT_PTR iStateId, INT_PTR iPropId,  INT_PTR *piVal)
{
...
HRESULT CVisualStylesXP::GetThemeEnumValue(HTHEME hTheme, INT_PTR iPartId, 
										   INT_PTR iStateId, INT_PTR iPropId,  INT_PTR *piVal)
{
...
HRESULT CVisualStylesXP::GetThemePosition(HTHEME hTheme, INT_PTR iPartId, 
...
HRESULT CVisualStylesXP::GetThemeFont(HTHEME hTheme,  HDC hdc, INT_PTR iPartId, 
...
HRESULT CVisualStylesXP::GetThemeRect(HTHEME hTheme, INT_PTR iPartId, 
...
HRESULT CVisualStylesXP::GetThemeMargins(HTHEME hTheme,  HDC hdc, INT_PTR iPartId, 
...
HRESULT CVisualStylesXP::GetThemeIntList(HTHEME hTheme, INT_PTR iPartId, 
...
HRESULT CVisualStylesXP::GetThemePropertyOrigin(HTHEME hTheme, INT_PTR iPartId, 
...
HRESULT CVisualStylesXP::GetThemeFilename(HTHEME hTheme, INT_PTR iPartId, 
...
HRESULT CVisualStylesXP::GetThemeSysInt(HTHEME hTheme, INT_PTR iIntId, INT_PTR *piValue)
{
